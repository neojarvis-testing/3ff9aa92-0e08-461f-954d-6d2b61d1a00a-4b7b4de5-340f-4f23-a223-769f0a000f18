...
public class BuyerModulePageLocator {
    ...
    public static By HoverOnBuyer=By.cssSelector("div[class='nail-entrance'] a[ads-data='st:103']");
    public static By ClickNewUserGuide=By.xpath("//a[text()='New User Guide']");
    public static By ClickLogo=By.xpath("a[title='Manufacturers & Suppliers']");
