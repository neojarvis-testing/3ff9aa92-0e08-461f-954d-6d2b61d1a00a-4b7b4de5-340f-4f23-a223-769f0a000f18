...
public class SignInPageLocator {
    ...
    public static By verify = By.xpath("//div[@class='ft-form-item register-btn-wrap']/div/div[@class='ft-form-item-input']");
    ...
    public static By signin = By.cssSelector("//button[@id='sign-in-submit']");
    ...
    public static By lasterror = By.cssSelector("//label[contains(text(),'Please enter the text in the image.')]");
