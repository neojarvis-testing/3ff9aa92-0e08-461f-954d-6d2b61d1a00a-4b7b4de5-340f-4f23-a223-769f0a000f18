...
public class MadeInChinaHotItemsPage {
    ...
    //         Assert.assertTrue(autoPartsUrl.contains("Auto-Parts_Accessories.html"));
    //         LoggerHandler.info("Verified Auto-Parts_Accessories.html");
    //         test.log(Status.PASS, "Verified Auto-Parts_Accessories.html");
    //     } catch (Exception e) {
    //         LoggerHandler.error("Not Verified Auto-Parts_Accessories.html");
    //         test.log(Status.FAIL, "Not Verified Auto-Parts_Accessories.html");
    //     }
    // }
    ...
    //     try {
    //         String furnitureUrl = helper.getTitle();
    //         Assert.assertTrue(furnitureUrl.contains("Bags, Cases & Luggages"));
